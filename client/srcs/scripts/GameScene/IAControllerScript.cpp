...
// // CANONICAL #####################################################
//
// IAControllerScript::IAControllerScript ( int playerId )
// {
...
// }
//
// IAControllerScript::IAControllerScript ( IAControllerScript const & src )
// {
// 	*this = src;
// 	return ;
// }
//
// IAControllerScript &				IAControllerScript::operator=( IAControllerScript const & rhs )
// {
// 	if (this != &rhs)
// 	{
// 		// make stuff
...
// }
//
// IAControllerScript::~IAControllerScript ( void )
// {
// 	return ;
// }
//
// std::ostream &				operator<<(std::ostream & o, IAControllerScript const & i)
// {
// 	(void)i;
// 	return (o);
// }
...
// // PUBLIC METHOD #################################################
//
// void						IAControllerScript::unlockCharacterDirections(void)
// {
...
// }
//
// void						IAControllerScript::Start(void)
// {
...
// }
//
// void								IAControllerScript::Attack(void)
// {
// 	if (this->bomb <= 0)
// 		return ;
...
// }
//
// void 								IAControllerScript::BombExplode()
// {
// 	this->bomb++;
// }
//
// void								IAControllerScript::MUp(void)
// {
...
// }
//
// void								IAControllerScript::MDown(void)
// {
...
// }
//
// void								IAControllerScript::MLeft(void)
// {
...
// }
//
// void								IAControllerScript::MRight(void)
// {
...
// }
//
// void						IAControllerScript::Update(void)
// {
...
// 		std::make_pair(SDL_SCANCODE_Q, &IAControllerScript::Attack), std::make_pair(SDL_SCANCODE_UP, &IAControllerScript::MUp),
// 		std::make_pair(SDL_SCANCODE_DOWN, &IAControllerScript::MDown), std::make_pair(SDL_SCANCODE_LEFT, &IAControllerScript::MLeft),
// 		std::make_pair(SDL_SCANCODE_RIGHT, &IAControllerScript::MRight)
// 	};
//
//
...
// 	{
// 		IAControllerScript *controllerScript = ((IAControllerScript*)this->scene->current_player->GetComponent<Script>());
// 		if (controllerScript) {
...
// }
//
// void								IAControllerScript::OnPreRender(void)
// {
// 	//bind shader
...
// }
//
// void								IAControllerScript::OnEndRender(void)
// {
// 	//unbind shader
//
// }
//
// void						IAControllerScript::OnCollisionEnter(GameObject *collider)
// {
...
// }
//
// int 										IAControllerScript::getPlayerId()
// {
// 	return this->playerId;
// }
//
// int 										IAControllerScript::getPower()
// {
// 	return this->power;
// }
// // ###############################################################
